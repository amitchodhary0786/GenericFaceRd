...
public class FailedActivity extends AppCompatActivity {
    ...
    String ssoLoginTokan,FailedStatusId;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        FailedStatusId = getIntent().getStringExtra("FailedStatusId");

        getPendingData(FailedStatusId,ssoLoginTokan,ssoLoginTokan);
    }
    public void getPendingData(String SuccessStatusId,String SuccessStatusId1,String ssoLoginTokan){
        WebServiceHandler webServiceHandler =new WebServiceHandler(FailedActivity.this);
    ...
    public void showDialog(String AadhaarRefNo,String Purpose,String RequestDate,String RequestId,String RequestType,String SubauaName){
        Dialog dialog = new Dialog (FailedActivity.this );
