...
public class SuccessActivity extends AppCompatActivity {
    ...
    String ssoLoginTokan,SuccessStatusId;
    RecyclerView rv_success;
     ArrayList<TransactionModel> transactionArray = new ArrayList<>();
    String AadhaarRefNo,Purpose,RequestDate,RequestId,RequestType,SubauaName;
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        ...
        SuccessStatusId = getIntent().getStringExtra("SuccessStatusId");

        getPendingData(SuccessStatusId,ssoLoginTokan,ssoLoginTokan);
    }


    public void getPendingData(String SuccessStatusId,String SuccessStatusId1,String ssoLoginTokan){
        WebServiceHandler webServiceHandler =new WebServiceHandler(SuccessActivity.this);
    ...
    public void showDialog(String AadhaarRefNo,String Purpose,String RequestDate,String RequestId,String RequestType,String SubauaName){
        Dialog dialog = new Dialog (SuccessActivity.this );
